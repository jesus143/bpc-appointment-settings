                    ...
                    <?php foreach($dates as $petsa => $date): ?>
                        <tr class="bpc-as-row-schedule" id="bpc-as-row-schedule-<?php print $petsa; ?>" >
                            ...
                            <td class="agenda-time">
                                <select  name="" class="bpc-as-hour-dropdown"><?php bpc_as_generate_hours_option(); ?> </select>
                                <select  name="" class="bpc-as-hour-dropdown"><?php bpc_as_generate_minutes_option(); ?> </select>
                            </td>
